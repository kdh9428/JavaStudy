...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID="fG23JuyLUbjyoeA7VYSk";
	private final static String CLIENT_SECRET = "llG9pMu8dQ";
	private final static String REDIRECT_URI = "http://localhost:8090/study200/callback";
